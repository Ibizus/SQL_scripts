drop table if exists libros, editoriales;
 ...
 create table libros(
  ...
  primary key(codigo),
  foreign key (codigoeditorial) references editoriales(codigo) on update cascade
 );
 --  foreign key (codigoeditorial) references editoriales(codigo) on update cascade --
 -- Hemos añadido esta linea anterior
...
--  /* Se hace de hijo a padre para no crear conflictos de huerfanos */
 update libros as l
