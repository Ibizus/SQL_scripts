...
DROP TRIGGER IF EXISTS t_actualiza_record;
DELIMITER //
CREATE TRIGGER t_actualiza_record 
after INSERT
ON saltos FOR EACH ROW

BEGIN
 
 	update deportistas_saltos set mejor_marca_personal = new.marca where id_deportista = new.id_deportista and mejor_marca_personal < new.marca;
